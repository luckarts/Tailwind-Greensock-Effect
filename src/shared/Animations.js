...
// OPEN MENU
export const gsapTo = (element, effect) => {
  gsap.to(element, effect);
};
export const gsapFrom = (element, effect) => {
  gsap.from(element, effect);
};
export const gsapFromTo = (element, startEffect, endEffect) => {
  gsap.fromTo(element, startEffect, endEffect);
};
// CLOSE MENU
